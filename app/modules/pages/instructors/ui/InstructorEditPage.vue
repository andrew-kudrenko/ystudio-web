...
import type { InstructorEditFormValues } from "../model/types";
...
const formValues = reactive<InstructorEditFormValues>({
...
async function handleSubmit(event: FormSubmitEvent<InstructorEditFormValues>) {
