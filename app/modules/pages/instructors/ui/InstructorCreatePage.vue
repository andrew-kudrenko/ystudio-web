...
import type { InstructorCreateFormValues } from "../model/types";
import type { Studio } from "~/types";

const toast = useToast();

const formValues = reactive<InstructorCreateFormValues>({
  name: "",
  description: "",
  address: "",
  capacity: 0,
...
async function handleSubmit(
  event: FormSubmitEvent<InstructorCreateFormValues>,
) {
